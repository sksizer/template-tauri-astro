...
cd src-astro && pnpm outdated 2>&1 || true; cd ..
...
```
pnpm update 2>&1
cd src-astro && pnpm update 2>&1; cd ..
...
- Body: two sections —
  - **JS packages bumped** (grouped by root / src-astro, from the pnpm update output)
