...
#
# Replaces all template default references (example-tauri-astro / com.sksizer.example-tauri-app)
...
OLD_NAME="example-tauri-astro"
OLD_NAME_UNDERSCORE="example_tauri_astro"
OLD_BUNDLE_ID="com.sksizer.example-tauri-app"
...
OLD_LIB_NAME="${OLD_NAME_UNDERSCORE}_lib"
