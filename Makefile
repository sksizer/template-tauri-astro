...
help: ## Show this help message
	...
	@echo "  storybook      Launch Storybook dev server (placeholder)"
	@echo "  ports          Show auto-assigned port block for this worktree"
	@echo ""
	@echo "Frontend:"
	@echo "  frontend-dev          Run Astro dev server"
	@echo "  frontend-build        Build Astro for production"
	@echo "  frontend-preview      Preview Astro production build"
...
storybook: ## Launch Storybook dev server (placeholder)
...
frontend-dev: ## Run Astro dev server
	cd src-astro && pnpm run dev

frontend-build: ## Build Astro for production
	cd src-astro && pnpm run build

frontend-preview: ## Preview Astro production build
...
storybook-build: ## Build Storybook static site (placeholder)
	@echo "Storybook is not yet configured for this project."

ci: lint format-check typecheck test build ## Run full CI pipeline
